...
- (id)init {
	if (self=[super init]) {
		...
		[defaults registerDefaults:[NSDictionary dictionaryWithObjectsAndKeys:
			...
			[NSNumber numberWithBool:NO], QuitWhenClosingMainWindowKey,
			...
			[NSNumber numberWithBool:YES], KeepsMaxTextWidth,
			[NSNumber numberWithFloat:800.0], NoteBodyMaxWidth,
            ...
            [NSNumber numberWithBool:YES], UseAutoPairing,
			...
			[NSArchiver archivedDataWithRootObject:
			 [NSColor systemYellowColor]], SearchTermHighlightColorKey,
